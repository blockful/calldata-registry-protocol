...
export const mockDrafts: Draft[] = [
  {
    ...
    description:
      "Updates one executor parameter and publishes the exact encoded payload for review.",
    extraData: "0x",
    ...
    reviews: [
      {
        ...
        decision: "rejected",
        comment: "The submitted payload does not match the intended value.",
  ...
  },
  {
    ...
    description: "Parallel fork of draft #2 testing a replacement module.",
    extraData: "0x",
    previousVersion: "2",
  ...
  },
  {
    ...
    description: "Fork of draft #6 returning to the original module and adding the companion action.",
    extraData: "0x",
    previousVersion: "6",
  ...
  },
  {
    ...
    description: "Parallel fork of draft #6 with the reviewed action set retained.",
    extraData: "0x",
    previousVersion: "6",
    ...
    reviews: [
      {
        ...
        reviewer: "0x512B982C87425B57B8F1a99DA4C3B26C21517e19",
        decision: "approved",
        comment: "Final payload matches the reviewed action set.",
  ...
  },
  {
    ...
    description: "Initial signer rotation payload.",
    extraData: "0x",
    previousVersion: null,
  ...
  },
  {
    ...
    executor: "safe.treasury.eth",
    proposer: "0x21D0fb5a14dBbAF938dE0a36902A6527d9d9F77b",
    description: "Fork of draft #3 with a second action.",
    extraData: "0x",
    previousVersion: "3",
    ...
    reviews: [
      {
        ...
        reviewer: "0x512B982C87425B57B8F1a99DA4C3B26C21517e19",
        decision: "approved",
        comment: "Target and encoded data match the reviewed transfer.",
