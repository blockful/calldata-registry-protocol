...
import { CalldataReviewResolverAbi } from "./abis/CalldataReviewResolverAbi";
...
export default createConfig({
  ...
  contracts: {
    ...
    CalldataReviewResolver: {
      abi: CalldataReviewResolverAbi,
      chain: "anvil",
      address: (process.env.RESOLVER_ADDRESS ?? "0x0000000000000000000000000000000000000000") as `0x${string}`,
      startBlock: 0,
    },
  },
});
